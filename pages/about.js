    ...
    <>
      <Head>
        ...
        <meta
          ...
          content={
            isFr
              ? "À propos du Groupe scolaire bilingue La Gracieuse – mission, histoire, installations et identité bilingue."
      ...
      <section>
        <div className="container grid grid-2">
          <div className="card glass">
            <h2>{isFr ? "Histoire et identité" : "History and identity"}</h2>
            <div style={{ margin: "0.75rem 0 1rem" }}>
              <Image
                src={founderImg}
                alt={isFr ? "Fondatrice de La Gracieuse" : "Founder of La Gracieuse"}
            ...
            <p className="lead">
              {isFr
                ? "La Gracieuse est née au cœur de la ville pour offrir une immersion équilibrée en anglais et français avec des enseignants bienveillants."
            ...
            <ul className="list">
              ...
              <li>{isFr ? "Bibliothèque, salle informatique et espaces d'arts créatifs" : "Library, computer room, and creative arts spaces"}</li>
            </ul>
            <div className="note" style={{ marginTop: "0.75rem" }}>
              {isFr
                ? "Nous cultivons la curiosité, la bienveillance et une communication assurée dans les deux langues."
                : "We celebrate curiosity, kindness, and confident communication in both languages."}
            </div>
          </div>
          <div className="card">
            <h2>{isFr ? "Mission et valeurs" : "Mission and values"}</h2>
            <div className="grid grid-2">
              <div>
                <div className="badge">{isFr ? "Apprentissage" : "Learning"}</div>
                <p className="muted">
                  {isFr
                    ? "Activités pratiques, éveil à la lecture et aux nombres avec un accompagnement attentif."
                    : "Hands-on activities, early literacy, and numeracy with caring guidance."}
                </p>
              </div>
              <div>
                ...
                <p className="muted">
                  {isFr
                    ? "Espaces sûrs pour les enfants, jeux encadrés et adultes de confiance au quotidien."
                    : "Child-safe spaces, supervised play, and trusted adults every day."}
                </p>
              </div>
              <div>
                <div className="badge">{isFr ? "Bilinguisme" : "Bilingualism"}</div>
                <p className="muted">
                  {isFr ? "Immersion équilibrée menée par des enseignants francophones et anglophones." : "Balanced immersion led by French and English teachers."}
                </p>
              </div>
              <div>
                <div className="badge">{isFr ? "Communauté" : "Community"}</div>
                <p className="muted">
                  {isFr ? "Parents accueillis en partenaires avec une communication transparente." : "Parents welcomed as partners with transparent communication."}
                </p>
              </div>
            </div>
      ...
      <section>
        <div className="container">
          <div className="section-head">
            <div>
              <div className="pill">{isFr ? "Installations" : "Facilities"}</div>
              <h2>{isFr ? "Des espaces pensés pour un apprentissage joyeux" : "Spaces designed for joyful learning"}</h2>
              <p>
                {isFr
                  ? "Des classes lumineuses, des aires de jeux extérieures et une bibliothèque en expansion soutiennent la curiosité de chaque enfant."
          ...
          <div className="grid grid-3">
            <div className="card hero-bubble">
              ...
              <p className="muted">
                {isFr
                  ? "Salles ensoleillées avec coins bilingues, espaces lecture et assises modulables."
                  : "Sunlit rooms with bilingual corners, reading nooks, and flexible seating."}
              </p>
            </div>
            <div className="card hero-bubble">
              ...
              <p className="muted">
                {isFr
                  ? "Jeux extérieurs sécurisés avec surveillance, équipements sportifs et espaces verts."
                  : "Safe outdoor play with supervision, sports equipment, and green space."}
              </p>
            </div>
            <div className="card hero-bubble">
              <h3>{isFr ? "Bibliothèque et numérique" : "Library & tech"}</h3>
              <p className="muted">
                {isFr
                  ? "Heures du conte, salle informatique pour les premières compétences numériques et ateliers créatifs."
                  : "Storytelling sessions, computer room for early tech skills, and creative labs."}
              </p>
            </div>
          </div>
        </div>
      ...
      <section>
        <div className="container card glass">
          <div className="grid grid-2">
            <div>
              <h2>{isFr ? "Nous visiter" : "Visit us"}</h2>
              <p className="muted">
