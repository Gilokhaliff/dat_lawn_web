const translations = {
  en: {
    ...
    highlights_heading: "Honest lawn tips from a content creator",
    why_logo_title: "DAT LAWN GUY",
    why_logo_sub: "Content creator, not a lawn expert",
    why_quote: "I learned a lot through my own mistakes and share what actually helped me.",
    why_intro:
      "I’m not a company and not a turf expert. I’m a content creator who learned a lot through trial, error, and plenty of mistakes.",
    why_para:
      "That’s exactly what I share here: practical tips for watering, seeding, feeding, mowing, and fixing issues, including what I’d do differently today.",
    why_point1: "Real learnings instead of marketing copy.",
    why_point2: "Simple, clear steps, especially for beginners.",
    why_point3: "If lawn mistakes cost you time and money, this is for you.",
    why_outro: "If you want to get your lawn back in shape step by step, I’ll help with honest tips from my own experience.",
    why_stat1_label: "Routes per week",
    why_stat2_label: "Rasenwelt code",
    why_stat3_label: "Community",
    why_tag1: "Own experience",
    why_tag2: "Photo + video examples",
    why_tag3: "Simple explanations",
  ...
  de: {
    ...
    highlights_heading: "Ehrliche Rasentipps von einem Content Creator",
    why_logo_title: "DAT LAWN GUY",
    why_logo_sub: "Content Creator, kein Rasen-Experte",
    why_quote: "Ich habe viel durch eigene Fehler gelernt und teile, was mir wirklich geholfen hat.",
    why_intro:
      "Ich bin keine Firma und kein Rasen-Experte. Ich bin Content Creator und habe durch Versuch, Irrtum und viele Fehler extrem viel gelernt.",
    why_para:
      "Genau diese Learnings teile ich hier: praktische Tipps zu Bewässerung, Nachsaat, Düngung, Mähen und Problembehebung, inklusive dem, was ich heute anders machen würde.",
    why_point1: "Echte Learnings statt Werbeversprechen.",
    why_point2: "Einfache, klare Schritte, auch für Anfänger.",
    why_point3: "Wenn dich Fehler beim Rasen Zeit und Geld gekostet haben, bist du hier richtig.",
    why_outro: "Wenn du deinen Rasen Schritt für Schritt auf Vordermann bringen willst, helfe ich dir mit ehrlichen Tipps aus meiner Erfahrung.",
    why_stat1_label: "Routen pro Woche",
    why_stat2_label: "Rasenwelt-Code",
    why_stat3_label: "Community",
    why_tag1: "Eigene Erfahrungen",
    why_tag2: "Foto + Video-Beispiele",
    why_tag3: "Einfach erklärt",
